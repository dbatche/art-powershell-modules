function Get-GlAccountTypes {
    <#
    .SYNOPSIS
        Retrieves GL account type records
    ...
    $uri = "$BaseUrl/glAccountTypes$queryString"
    ...
    try {
        ...
        if ($PassThru) {
            ...
            if ($response.glAccountTypes) {
                return $response.glAccountTypes
            } else {
                return $response
            }
        }
