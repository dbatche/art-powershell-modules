function Get-DriverPayments {
    <#
    .SYNOPSIS
        Retrieves driver payment records
    ...
    .PARAMETER Select
        ...
        Example: "driverPaymentId,driverId,amount"
    ...
    $uri = "$BaseUrl/driverPayments$queryString"
    ...
    try {
        ...
        if ($PassThru) {
            ...
            if ($response.driverPayments) {
                return $response.driverPayments
            } else {
                return $response
            }
        }
