function Get-CurrencyRates {
    <#
    .SYNOPSIS
        Retrieves currency rate records [/currencyRates]
    ...
    .PARAMETER Location
        Required. Currency rate location.
        Valid values: 'generalLedger' or 'driverPay'
    ...
    .PARAMETER Select
        ...
        Example: "currencyRateId,currencyCode,rate"
    ...
    $uri = "$BaseUrl/currencyRates$queryString"
