function Get-DriverDeductionCodes {
    <#
    .SYNOPSIS
        Retrieves driver deduction code records
    ...
    $uri = "$BaseUrl/driverDeductionCodes$queryString"
    ...
    try {
        ...
        if ($PassThru) {
            ...
            if ($response.driverDeductionCodes) {
                return $response.driverDeductionCodes
            } else {
                return $response
            }
        }
