function Get-VendorPayments {
    <#
    .SYNOPSIS
        Retrieves vendor payment records
    ...
    .PARAMETER Select
        ...
        Example: "vendorPaymentId,vendorId,amount"
    ...
    $uri = "$BaseUrl/vendorPayments$queryString"
