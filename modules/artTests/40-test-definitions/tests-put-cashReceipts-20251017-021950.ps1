...
@(
    ...
    @{
        ...
        Type = 'Contract'
        Body = @{ checkDate = 'InvalidPatternValue'; checkReference = 'AAAAAAAAAA' }
    },
    @{
        ...
        Type = 'Contract'
        Body = @{ postDated = 'InvalidEnumValue_NotInList'; checkReference = 'AAAAAAAAAA' }
    },
    @{
        ...
        ExpectedErrorCode = 'exceedsMaxLength'
        Type = 'Contract'
        Body = @{ checkNumber = 'AAAAAAAAAAAAAAAA'; checkReference = 'AAAAAAAAAA' }
    },
    @{
    ...
    @{
        ...
        ExpectedErrorCode = 'invalidString'
        Type = 'Contract'
        Body = @{ checkDate = 12345; checkReference = 'AAAAAAAAAA' }
    },
    @{
    ...
    @{
        ...
        ExpectedStatus = 200
        Type = 'Functional'
        Body = @{ checkAmount = 100; clientId = 'AAAAAAAAAA'; checkDate = '2025-01-15'; checkNumber = 'AAAAAAAAAA'; bankAccount = 'AAAAAAAAAA'; checkReference = 'AAAAAAAAAA'; postDated = 'False' }
    }
)
